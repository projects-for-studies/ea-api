...
DeviseTokenAuth.setup do |config|
  ...
  # knows where to redirect users after successful email confirmation.
  # If this param is set, the API will redirect to this value when no value is provided by the client.
  config.default_confirm_success_url  = 'http://localhost:8080/entrar'
  ...
  # If this param is set, the API will redirect to this value when no value is provided by the client.
  config.default_password_reset_url  = 'http://localhost:8080/resetar-senha'
